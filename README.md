Mirror
An AI-powered self-reflection and journaling web application built with React and TypeScript. Mirror uses the OpenAI API to provide intelligent responses to your journal entries, helping you process thoughts, track emotional patterns, and gain deeper self-awareness over time.
...
npm run dev
Author
Fahad Hanief — github.com/ShadeHD
